...
void FVP::OpenOverallSave()
{
  try
  {
    overall_save_file_ = Utility::PersistentFile::Construct(std::vformat("{}/save/save.bin", std::make_format_args(save_file_directory_)), Utility::PersistentFile::Permissions::READ_WRITE, Utility::PersistentFile::CreateFile::NO_CREATE_FILE);
...
{
  HCB_file_ = Utility::PersistentFile::Construct(std::vformat("{}/Snow.hcb", std::make_format_args(data_directory_)), Utility::PersistentFile::Permissions::READ, Utility::PersistentFile::CreateFile::NO_CREATE_FILE);
